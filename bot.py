...
async def start(bot, message):
    await message.reply(
        ...
        "**I am your Personal MDisk Link Converter Bot 🤗, Made by 🍷@imdbott🍷 Send me a MDisk Post to see the Magic 😅**")
    
@bot.on_message(filters.text & filters.private)
async def Doodstream_uploader(bot, message):
    new_string = str(message.text)
    conv = await message.reply("Wait Bnaraha Hu..... Tab Tak 🍷@imdbott🍷 Check Karo✋")
